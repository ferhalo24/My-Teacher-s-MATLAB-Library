function Wrench=Gravity_Wrench(action_solid_name,wrt_point_name)

global Solids l SolidsNames
...
[FG_Sol,MG_Sol_wrt_point,wrt_point_name] = newGravity_Force_Moment( action_solid_name, wrt_point_name);
Wrench=Vector6D(FG_Sol,MG_Sol_wrt_point,wrt_point_name);
