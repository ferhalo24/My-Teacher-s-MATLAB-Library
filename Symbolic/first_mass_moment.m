function [d_Sol_P_Sol,P_Sol_point_name]=first_mass_moment(Sol_solid_name,P_Sol_point_name)
...
P_Sol_G_Sol=Pos(P_Sol_point_name,gravity_center_point_name);

d_Sol_P_Sol=m_Sol*P_Sol_G_Sol;
