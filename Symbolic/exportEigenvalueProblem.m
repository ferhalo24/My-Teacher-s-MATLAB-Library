function exportEigenvalueProblem(dyn_equations_type)
global t q dq ddq epsilon lambda lambda_aux param
global delta_v delta_q
global dPhi dPhi_dq ddPhi Dyn_eq_VP Dyn_eq_L
...
matlabFunction(K_qq,'File','K_qq_','Vars',{q,dq,ddq,lambda,t,param},'Optimize',optimize_matlabFunction);
