function velocity_vector=Vel(frame_name1,point_name,frame_name2)
...
if nargin==3
    ...
    velocity_vector = velocity_vector + cross( Omega( wrt_frame_base_number,point_frame_base_name), Pos(point_frame_origin_name,point_name) );
end
