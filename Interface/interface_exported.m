classdef interface_exported < matlab.apps.AppBase
    ...
    methods (Access = public)
        ...
        function results = newVariableSlider(app,name,variable_limits)
            ...
            if n_VariableSliders==1
            app.VariableSliders(n_VariableSliders).Position = [200,30,83,7];
            else
            ...
            app.VariableSliders(n_VariableSliders).Value=getValue(name(1));
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create PauseButton
            app.PauseButton = uibutton(app.InterfaceUIFigure, 'push');
            app.PauseButton.ButtonPushedFcn = createCallbackFcn(app, @PauseButtonPushed, true);
            app.PauseButton.Position = [4 375 90 22];
